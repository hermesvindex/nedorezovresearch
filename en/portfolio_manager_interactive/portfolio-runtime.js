(() => {
  ...
  const copy = {
    ru: {
      skip: "Skip to content", languageLabel: "Yazyk interfeysa", eyebrow: "PORTFOLIO BUILDER",
      introTitle: "Razmestite dengi in sootvetstvii with vashey tselyu",
      introCopy: "The builder allocates capital by horizon, liquidity and risk, then presents three explainable scenarios using bonds, equities, exchange-traded funds and gold.",
      start: "Nachat calculation", method: "Kak rabotaet calculation", timeEstimate: "5 korotkikh etapov · okolo 3 minut · otvety mozhno izmenit",
      trustLabel: "Osnovnye svoystva", trustLocalTitle: "Otvety ostayutsya on ustroystve", trustLocalText: "Without akkaunta and otpravki on server. Data sokhranyayutsya tolko in etom brauzere.",
      trustRiskTitle: "Risk razlozhen by actualoram", trustRiskText: "Liquidity, drawdown, credit, interest-rate and currency risk.",
      trustChoiceTitle: "Reshenie ostaetsya for vami", trustChoiceText: "Servis sravnivaet stsenarii and raskryvaet ogranicheniya rascheta.",
      privacyTitle: "Konfidentsialnost", privacyFull: "My ne zaprashivaem FIO, telefon, email or rekvizity scheta. Otvety and sostav portfolio sokhranyayutsya tolko in lokalnom khranilishche etogo brauzera, ne peredayutsya on server or in analitiku. Ikh mozhno udalit knopkoy sbrosa.", legalShort: "Informatsionnyy servis · Ne yavlyaetsya individualnoy investitsionnoy rekomendatsiey · Stoimost aktivov mozhet snizitsya",
      privacyStatus: "Lokalnaya obrabotka", progressLabel: "Progress ankety", exit: "Vyyti", liveProfile: "TEKUShchIY PROFIL", profilePending: "Utochnyaetsya",
      previewGoal: "Tsel", previewHorizon: "Horizon", previewLiquidity: "Likvidnyy rezerv", previewBroker: "Broker", privacyShort: "Otvet sokhranyaetsya tolko lokalno in etom brauzere.",
      back: "Back", next: "Prodolzhit", calculate: "Sformirovat portfel", resetSavedData: "Reset", resultEyebrow: "REZULTAT RASChETA", resultsTitle: "Sformirovannyy portfel", editAnswers: "Izmenit otvety", constructorMode: "Asset classicheskiy konstruktor", constructorFrameTitle: "Interactive portfolio builder", constructorSection: "Nastroyte portfel", constructorSectionText: "Calculation perenesen in konstruktor. Izmenyayte summu, vesa and sostav instrumentov neposredstvenno in tablitse.",
      scenarioLabel: "Stsenarii", allocationEyebrow: "STRAsset ManagerTURA", allocationTitle: "Raspredelenie kapitala", modelDate: "Modelnye parametry · 11.09.2026",
      stressEyebrow: "STRESS-TEST", stressTitle: "Chto mozhet proizoyti", cashflowEyebrow: "Cash Flow", cashflowTitle: "Vyplaty and reinvestirovanie",
      brokerEyebrow: "REALIZATsIYa", brokerTitle: "Broker and expenses", checksEyebrow: "KONTROL", checksTitle: "Ogranicheniya portfolio",
      disclosureTitle: "", disclosureText: "Expected value, return, cash flow and stress scenarios are model estimates. Fees, taxes, spreads, instrument availability and individual constraints are excluded from the calculation. Before trading, verify the data date and the current terms of the selected instruments. Nedorezov Research does not receive, transmit, store or analyse questionnaire responses or the composition of your portfolio.",
      restart: "Nachat novyy calculation", methodEyebrow: "METODIKA", methodTitle: "Kak stroyatsya stsenarii", close: "Close",
      methodStep1: "A mandatory liquidity reserve is calculated.", methodStep2: "Risk capacity and risk tolerance are assessed separately.", methodStep3: "Totalvyy risk ogranichivaetsya bolee nizkoy otsenkoy.", methodStep4: "Instruments filtruyutsya by sroku, dostupu, likvidnosti and strukture.", methodStep5: "Sformirovannyy portfel prokhodit stress-test and proverku kontsentratsiy.", methodNote: "Expected return yavlyaetsya modelnoy otsenkoy, a ne obeshchaniem rezultata.",
      q1k: "ETAP 1 · TsEL And SROK", q1t: "For chego and on kakoy srok razmeshchayutsya dengi?", q1h: "Tsel and srok zadayut osnovnoe ogranichenie riska.",
      q2k: "ETAP 2 · EQUITY And LIKVIDNOST", q2t: "Skolko razmeshchaetsya and kakaya chast mozhet neozhidanno ponadobitsya?", q2h: "",
      q3k: "ETAP 3 · RISK", q3t: "Gotovnost to risku", q3h: "Ukazhite vremennoe snizhenie stoimosti portfolio, under kotorom vy smozhete sokhranit vybrannyy srok investirovaniya.",
      q4k: "ETAP 4 · VYPLATY And OPYT", q4t: "Kak ispolzovat paymentsy and kakoy u vas opyt?", q4h: "Rezhim payments vliyaet on cash flow, opyt — on slozhnost dostupnykh instrumentov.",
      q5k: "ETAP 5 · INSTRUMENTY", q5t: "Kakie klassy aktivov ispolzovat?", q5h: "Kreditnoe kachestvo and limity kontsentratsii rasschityvayutsya avtomaticheski by vashemu profilyu.",
      q6k: "ShAG 6 · PROSADKA", q6t: "Kakoe vremennoe snizhenie priemlemo?", q6h: "Otsenivayte padenie stoimosti in RUBlyakh, a ne tolko in protsentakh.",
      q7k: "ShAG 7 · POVEDENIE", q7t: "Chto vy sdelaete under snizhenii portfolio?", q7h: "Otvet otsenivaet gotovnost sokhranyat vybrannuyu strategiyu in stressovom periode.",
      q8k: "ShAG 8 · OPYT", q8t: "Kakoy u vas opyt investirovaniya?", q8h: "Slozhnost instrumentov ogranichivaetsya opytom and chastotoy kontrolya.",
      q9k: "ShAG 9 · SChET", q9t: "Cherez kogo vy sovershaete sdelki?", q9h: "Broker vliyaet on dostupnost instrumentov and actualicheskie expenses. Tarify nuzhno proveryat pered sdelkoy.",
      q10k: "ShAG 10 · SOSTAV", q10t: "Kakie ogranicheniya uchityvat?", q10h: "Parametry ispolzuyutsya for struktury modelnykh stsenariev.",
      required: "Zapolnite obyazatelnye polya.", invalidAmount: "Ukazhite summu from 10 000 until 1 000 000 000 RUBley.", invalidShare: "Ukazhite dolyu from 0 until 100%.", invalidAssets: "Vyberite khotya by odin klass aktivov.",
      goalReserve: "Sberech summu", goalReserveDesc: "Ogranichit kolebaniya and risk poteri kapitala", goalIncome: "Poluchat paymentsy", goalIncomeDesc: "Ispolzovat kupony and dividends kak regulyarnyy income", goalGrowth: "Narastit kapital", goalGrowthDesc: "Ostavlyat income in portfele radi dolgosrochnogo rosta",
      amount: "Nachalnaya summa, ₽", monthly: "Monthlye popolnenie, ₽", optional: "neobyazatelno",
      horizon6: "Until 6 mesyatsev", horizon12: "6–12 mesyatsev", horizon36: "1–3 year", horizon60: "3–5 years", horizonLong: "Bolee 5 years",
      flexible: "Srok mozhno perenesti on 12 mesyatsev and bolee", currency: "Currency budushchikh raskhodov", rub: "Expenses preimushchestvenno in RUBlyakh", foreign: "Est expenses, privyazannye to valyute", currencyHint: "Vyberite vtoroy variant, esli stoimost tseli zavisit from kursa: forRUBezhnaya nedvizhimost, obuchenie, poezdki, avtomobil, oborudovanie or drugie tovary with valyutnym tsenoobrazovaniem.",
      reserveMonths: "Sushchestvuyushchiy rezerv vne portfolio", reserve0: "Net", reserve1: "Until 1 mesyatsa raskhodov", reserve3: "1–3 months raskhodov", reserve6: "3–6 mesyatsev raskhodov", reserveMore: "Bolee 6 mesyatsev raskhodov",
      urgent: "Share portfolio, kotoraya mozhet neozhidanno ponadobitsya", reinvest: "Reinvestirovat", withdraw: "Vyvodit",
      maxLoss: "Maksimalnoe vremennoe snizhenie", lossRub: "Eto primerno {value} from nachalnoy summy", drawdownExplain: "Vremennoe snizhenie — padenie tekushchey stoimosti portfolio nizhe vlozhennoy summy. Ubytok fiksiruetsya under prodazhe aktivov until vosstanovleniya ikh stoimosti.",
      sellAll: "Prodam", sellPart: "Sokrashchu risk", hold: "Sokhranyu plan", buy: "Prodolzhu pokupki by planu",
      expNone: "Opyta net", expBasic: "Vklady", expMixed: "Money market", expAdvanced: "Equities and bonds",
      review: "Kak chasto gotovy proveryat portfel?", reviewMonth: "Monthly", reviewQuarter: "Raz in kvartal", reviewYear: "Odin-dva raza in year",
      broker: "Broker or bank", tariff: "Tarif or komissiya for sdelki", tariffUnknown: "Ne znayu", tariffLow: "Until 0,1%", tariffMid: "0,1–0,3%", tariffHigh: "Vyshe 0,3%", qualified: "Est status kvalifitsirovannogo investora", bondAccess: "Kvalifikatsiya and testirovanie", accessBasic: "Testy ne prokhodil", accessTested: "Prokhodil testirovanie", accessQualified: "Est status kvalifitsirovannogo investora", assetStocks: "Equities", assetFunds: "BPIFy", assetBonds: "Bonds",
      style: "Predpochtitelnaya forma vladeniya", styleFunds: "Preimushchestvenno BPIFy", styleDirect: "Preimushchestvenno pryamye bumagi", styleMixed: "Smeshannyy sostav",
      ofzCore: "Sformirovat osnovu obligatsionnoy chasti from OFZ", rating: "Minimalnyy rating corporate bonds", ratingAAA: "AAA and vyshe", ratingAA: "AA− and vyshe", ratingA: "A− and vyshe", ratingBBB: "BBB− and vyshe", ratingBB: "BB− and vyshe", ratingB: "B− and vyshe", ratingScope: "Credit ratingovyy filtr primenyaetsya to pryamym obligatsiyam. For BPIFov trebuetsya otdelnyy analiz sostava fonda.", gold: "Add zoloto", maxIssuer: "Maksimalnaya dolya korporativnogo issuer", sectionGoal: "Tsel", sectionHorizon: "Srok", sectionCapital: "Summa", sectionLiquidity: "Dostupnost deneg", sectionRisk: "Dopustimoe snizhenie", sectionBehavior: "Deystvie under snizhenii", sectionPayouts: "Vyplaty", sectionExperience: "Opyt", sectionAccount: "Broker and dostup", sectionAssets: "Sostav",
      conservative: "Konservativnyy", cautious: "Ostorozhnyy", balanced: "Sbalansirovannyy", growth: "Rostovoy",
      capability: "Risk-sposobnost", willingness: "Risk-gotovnost", liquidityFloor: "Minimalnyy rezerv", horizon: "Horizon", years: "years", month: "mes.",
      resultLead: "Stsenarii ogranicheny vashim srokom, likvidnym rezervom and dopustimoy prosadkoy.",
      defensive: "Zashchitnyy", base: "Base", dynamic: "Dinamichnyy", defensiveDesc: "Prioritet likvidnosti and ustoychivosti to prosadke.", baseDesc: "Balans zadannoy tseli, riska and ozhidaemogo rezultata.", dynamicDesc: "Maksimalnaya dolya rosta in predelakh rasschitannykh ogranicheniy.",
      expected: "Modelnyy diapazon", risk: "Kombinirovannyy stress", liquid: "Vysokolikvidno", yearSuffix: "in year", riskLow: "nizkaya chuvstvitelnost", riskMedium: "srednyaya chuvstvitelnost", riskHigh: "vysokaya chuvstvitelnost",
      classMoney: "Likvidnyy rezerv", classBonds: "Bonds", classEquity: "Equities", classGold: "Gold", instrument: "Instrument", share: "Share", amountLabel: "Summa", role: "Rol", currencyProtection: "Valyutnaya zashchita",
      roleMoney: "Srochnye expenses and stabilizatsiya", roleBonds: "Couponnyy income and srok", roleFxBonds: "Zashchita from oslableniya RUBlya", roleEquity: "Dolgosrochnyy rost", roleGold: "Diversifikatsiya and valyutnyy actualor",
      stressRate: "Stavki +2 pp", stressEquity: "Equities −30%", stressGold: "Gold −15%", stressCredit: "Credit stress", stressFx: "Rubl ukreplyaetsya on 15%", stressCombined: "Kombinirovannyy stress", portfolioEffect: "effekt on portfel",
      paymentsReinvest: "Vyplaty ostayutsya in portfele and uchastvuyut in slozhnom protsente.", paymentsWithdraw: "Coupons and dividends napravlyayutsya on schet. For stabilnoy paymentsy trebuetsya otdelnyy kalendar denezhnykh potokov.",
      indicativeIncome: "Orientir denezhnogo potoka", perMonth: "in mesyats until nalogov and komissiy", targetWithdrawal: "Zadannoe izyatie", coverage: "Raschetnoe pokrytie",
      brokerCandidate: "For {broker} in model vklyucheny exchange-traded fondy-kandidaty, vklyuchaya produkty upravlyayushchey kompanii {manager}. Dostupnost proveryaetsya in prilozhenii brokera.", brokerNeutral: "Vybran neytralnyy nabor likvidnykh birzhevykh instrumentov-kandidatov.",
      tariffCheck: "Komissiya brokera, spred, voznagrazhdenie fonda and nalogovyy rezhim in calculation return ne vklyucheny. Aktualnyy tarif ne podtverzhden.", affiliation: "Svyaz brokera and upravlyayushchey kompanii sama by sebe ne podtverzhdaet menshie sovokupnye expenses.",
      ok: "Vypolneno", attention: "Proverit", checkLiquidity: "Likvidnyy rezerv sootvetstvuet zadannoy potrebnosti", checkIssuer: "Share odnogo pryamogo issuer, vklyuchaya otdelnyy issue OFZ, ne prevyshaet 15%", checkQualified: "Instruments tolko for kvalifitsirovannykh investorov ne ispolzuyutsya", checkBondTest: "For bonds nizhe A+ broker mozhet potrebovat testirovanie. Status kvalifitsirovannogo investora sam by sebe ne obyazatelen", checkFees: "Fakticheskie komissii and spredy trebuyut proverki", checkCurrency: "Valyutnaya zashchita sformirovana pryamymi valyutnymi obligatsiyami in predelakh summy and limita issuer", checkCurrencySmall: "Summy nedostatochno for minimalnogo diversifitsirovannogo nabora valyutnykh bonds. Valyutnyy blok poyavitsya from 250 000 ₽.",
      modelOnly: "All znacheniya yavlyayutsya modelnymi otsenkami", noGuarantee: "Kombinirovannyy stress ne yavlyaetsya volatilnostyu, VaR, maksimalnym ubytkom or veroyatnostyu poteri. Return, likvidnost and stoimost aktivov mogut izmenitsya. Nalogi, komissii and individualnye ogranicheniya ne uchteny.",
      duration: "modifitsirovannaya dyuratsiya", ratingShort: "rating", fundDiversified: "diversifitsirovannyy fond", directSecurity: "pryamaya birzhevaya bumaga", preference: "uchtena vybrannaya forma vladeniya",
      notAssessed: "Ne otsenena", actualLiquidity: "Likvidnaya dolya",
      defaultPayments: "Pokazan raschetnyy cash flow current sostava portfolio. Rezhim vyvoda or reinvestirovaniya payments opredelyaetsya posle prokhozhdeniya ankety.",
      defaultLiquidityCheck: "Minimalnyy rezerv ne zadan: proydite anketu for proverki dostatochnosti likvidnoy doli", defaultIssuerCheck: "Share odnogo pryamogo issuer, vklyuchaya otdelnyy issue OFZ, ne prevyshaet 15%", defaultIssuerAttention: "Share odnogo pryamogo issuer, vklyuchaya otdelnyy issue OFZ, prevyshaet 15%", defaultCurrencyCheck: "In sostave portfolio est pryamye valyutnye bonds", defaultCurrencyMissing: "Pryamye valyutnye bonds in sostave portfolio otsutstvuyut"
    },
    en: {
  ...
  function money(value) {
    return new Intl.NumberFormat(state.locale === "ru" ? "en-GB" : "en-US", {
  ...
  function pct(value, digits = 0) {
    ...
    return `${new Intl.NumberFormat(state.locale === "ru" ? "en-GB" : "en-US", { maximumFractionDigits: digits }).format(normalized)}%`;
  }

  function managerName(name) {
    if (state.locale === "ru") return name;
    return {
      "VIM Investitsii": "VIM Investments",
      "Alfa-Equity": "Alfa-Capital",
      "Aton-menedzhment": "ATON Management",
      "Pervaya": "Pervaya",
      "T-Equity": "T-Capital",
      "BKS": "BCS",
      "Finam Menedzhment": "Finam Management"
    }[name] || name;
  }

  function applyTranslations() {
    document.documentElement.lang = state.locale;
    document.title = "Portfolio builder — Nedorezov Research";
